...
int main(int argc, char** argv)
{
  ...
  std::string videoname = "../video/myFace.mp4";
  ...
  vpTemplateTrackerLBPForwardAdditional tracker(&warp);
  vpTemplateTrackerWarpHomography warp2;
  vpTemplateTrackerSSDForwardAdditional tracker2(&warp2);
  //! [Construction]
